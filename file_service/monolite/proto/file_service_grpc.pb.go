...
const (
	FileService_GetFile_FullMethodName = "/file_service_monolite.FileService/GetFile"
	FileService_SetFile_FullMethodName = "/file_service_monolite.FileService/SetFile"
)
...
type FileServiceClient interface {
	...
	SetFile(ctx context.Context, opts ...grpc.CallOption) (FileService_SetFileClient, error)
}
...
func (c *fileServiceClient) SetFile(ctx context.Context, opts ...grpc.CallOption) (FileService_SetFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileService_ServiceDesc.Streams[1], FileService_SetFile_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &fileServiceSetFileClient{stream}
	return x, nil
}

type FileService_SetFileClient interface {
	Send(*SetFileRequest) error
	CloseAndRecv() (*SetFileResponse, error)
	grpc.ClientStream
}

type fileServiceSetFileClient struct {
	grpc.ClientStream
}

func (x *fileServiceSetFileClient) Send(m *SetFileRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *fileServiceSetFileClient) CloseAndRecv() (*SetFileResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
...
type FileServiceServer interface {
	...
	SetFile(FileService_SetFileServer) error
...
func (UnimplementedFileServiceServer) SetFile(FileService_SetFileServer) error {
...
func _FileService_SetFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(FileServiceServer).SetFile(&fileServiceSetFileServer{stream})
}

type FileService_SetFileServer interface {
	SendAndClose(*SetFileResponse) error
	Recv() (*SetFileRequest, error)
	grpc.ServerStream
}

type fileServiceSetFileServer struct {
	grpc.ServerStream
}

func (x *fileServiceSetFileServer) SendAndClose(m *SetFileResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *fileServiceSetFileServer) Recv() (*SetFileRequest, error) {
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "file_service_monolite.FileService",
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SetFile",
			Handler:       _FileService_SetFile_Handler,
			ClientStreams: true,
		},
	},
